	...
	Plasmoid.fullRepresentation: ColumnLayout {
		...
		Timer {
			...
			onTriggered: if(	!loadedsuccessfully &&
					...
					console.log("Failed to load DuckDuckGo AI Chat page, reloading as we are hidden..");
					...
					RowLayout {
						...
						RowLayout {
							...
							PlasmaComponents.ToolButton {
								text: i18n("Back to DuckDuckGo AI Chat")
								...
								onClicked: gptWebView.url = "https://duckduckgo.com/?q=DuckDuckGo&ia=chat";
							}
